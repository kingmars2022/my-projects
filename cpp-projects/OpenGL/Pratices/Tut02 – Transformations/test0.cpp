...
int main(int argc, char *argv[])
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // add a triangle
    // Top left triangle - translate by (-0.5, 0.25, -0.5)
    ...
    // camera shifted to the left
    if (glfwGetKey(window, GLFW_KEY_2) == GLFW_PRESS)
    {
      glm::mat4 viewMatrix = glm::lookAt(
          glm::vec3(-0.5f, 0.0f, 0.0f),  // eye position
          glm::vec3(-0.5f, 0.0f, -1.0f), // look at
