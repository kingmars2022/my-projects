...
int main(int argc, char *argv[])
{
    ...
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // TODO 1
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            // World matrix is identity (no transformation in world space)
            mat4 spinningCubeWorldMatrix(1.0f);

            // Draw in view space, 1 unit in front of the camera
        ...
        {
            // Third person: draw the cube in world space at the camera position
        ...
        */
        ...
        // @TODO 2 - Shoot Projectiles
        //
        // Shoot projectiles when the left mouse button is pressed
        // To detect a press event (not hold), we need to compare the current and previous button states
